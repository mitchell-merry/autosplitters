...
<Layout version="1.6.1">
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\Mitchell\Documents\development\autosplitter repos\kuno-asls\TheEvilWithin2.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="chap" type="bool">True</Setting>
          <Setting id="end" type="bool">True</Setting>
          <Setting id="starter" type="bool">True</Setting>
          <Setting id="2" type="bool">True</Setting>
          <Setting id="3" type="bool">True</Setting>
          <Setting id="4" type="bool">True</Setting>
          <Setting id="5" type="bool">True</Setting>
          <Setting id="6" type="bool">True</Setting>
          <Setting id="7" type="bool">True</Setting>
          <Setting id="8" type="bool">True</Setting>
          <Setting id="9" type="bool">True</Setting>
          <Setting id="10" type="bool">True</Setting>
          <Setting id="11" type="bool">True</Setting>
          <Setting id="12" type="bool">True</Setting>
          <Setting id="13" type="bool">True</Setting>
          <Setting id="14" type="bool">True</Setting>
          <Setting id="15" type="bool">True</Setting>
          <Setting id="16" type="bool">True</Setting>
          <Setting id="17" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
